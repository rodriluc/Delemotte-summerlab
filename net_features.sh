...
do
echo $file
python /home/lrodriguez/Delemotte-summerlab/MD_cmaps.py -top $file -trj $file -fe ${file%.*} -od /home/lrodriguez/Delemotte-summerlab/Results_data/ -sc_cmap
done
# Get binary contact map Origin pdb
for file in *.pdb
do
echo $file
python /home/lrodriguez/Delemotte-summerlab/MD_cmaps.py -d_in /home/lrodriguez/Delemotte-summerlab/Results_data/distance_matrix_min_${file%.*}.txt -fe ${file%.*} -od /home/lrodriguez/Delemotte-summerlab/Results_data/ -bin -coff 0.45
done
cd ..
